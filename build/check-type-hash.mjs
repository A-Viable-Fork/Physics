// Role: the canonical-form oracle, adapted from upstream/epistack/build/check-type-hash.mjs at the
//   pinned commit for this repo's vendored layout. Proves the one primitive the three-tier crossing
//   rests on: a type bundle hashes deterministically, identical bundles hash identically, any change
//   to a meaning-bearing field changes the hash, and the authored common-type hash literals match
//   what hashTypeBundle computes. This is the "canonical-form" substrate-behavior oracle named in
//   docs/status-ledger.md's oracle policy, self-contained and corpus-free like build/check-gate.mjs.
// Contract: `node build/check-type-hash.mjs` exits non-zero on any failure. Imports the vendored
//   kernel type-hash module and the vendored shared common-types seed.
...
//   DEPARTURE from the vendored original: import and require paths are rewritten from
//   "../kernel/..." and "../corpora/_shared/..." to "../vendor/kernel/..." and
//   "../vendor/corpora/_shared/...". No assertion differs; diffable against
//   upstream/epistack/build/check-type-hash.mjs at the pinned commit to confirm only paths changed.
"use strict";
import { createRequire } from "node:module";
import { hashTypeBundle, canonicalizeBundle } from "../vendor/kernel/schema/type-hash.mjs";
import { encode } from "../vendor/kernel/schema/canonical.mjs";

const require = createRequire(import.meta.url);
const { COMMON_BUNDLES, COMMON_TYPE_HASHES } = require("../vendor/corpora/_shared/common-types.js");
